...
\begin{itemize}
 ...
 \subitem \textbf{git-commit-id} Maven Plugin - widely used Git plugin for Apache Maven
 \subitem \textbf{ScalaWords} - Beautiful "words", library for common tasks
 \subitem \textbf{Janbanery} - Flutent Java API for Kanbanery.com
